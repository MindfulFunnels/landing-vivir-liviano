const config = {
  ...
  eventDateForCountdown: "2025-05-12T19:00:00", // Year-Month-DayThours:minutes:seconds
  ...
  colors: {
    primary: "#0066FF", // Para títulos y textos principales
    secondary: "#00A3FF", // Para subtítulos o textos secundarios
    background: "#000B2E", // Para el fondo
